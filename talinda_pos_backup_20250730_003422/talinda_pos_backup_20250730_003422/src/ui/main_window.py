...
class ModernMainWindow(QMainWindow):
    ...
    def show_about(self):
        """Show about dialog."""
        QMessageBox.about(self, tr("common.about", "About Talinda POS"), 
                         f"{tr('app_name', 'Talinda POS')} v2.0.0\n\n"
                         f"{tr('common.about_description', 'A modern Point of Sale system built with PyQt5.')}\n"
    ...
    def on_language_changed(self, language: str):
        ...
        try:
            ...
            if language == 'ar':
                QMessageBox.information(self, "تم تغيير اللغة", "تم تغيير اللغة إلى العربية")
            else:
            ...
            QMessageBox.warning(self, "Error", f"Error changing language: {str(e)}")
